...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <div class="fadeIn first">
            <img class="profile-image" src="<?=baseUrl()?>/image/empty-profile-128.png" id="icon" alt="User Icon" />
        </div>
        ...
        <div id="formFooter">
            ...
            <a style="text-decoration: none" href="<?=baseUrl()?>/user/register" class="underlineHover"><?=_btn_signup?></a>
        </div>
